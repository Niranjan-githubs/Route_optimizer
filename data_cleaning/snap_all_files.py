...
def main():
    ...
    route_json_path = 'vehicle_routes.json'
...
def process_specific_files():
    ...
    files_to_process = [
        {
            'input': 'cleaned_master_centroids.csv',
            'normal_output': 'cleaned_master_snapped.csv',
            'outlier_output': 'cleaned_master_snap_outliers.csv'
